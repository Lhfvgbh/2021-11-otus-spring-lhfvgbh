...
import ru.otus.homework_18.models.Comment;
...
class CommentRepositoryTest {
    ...
    void shouldInsertComment() {
        ...
        Comment actualResult = commentRepository.findById(expectedResult.getId()).orElse(new Comment());
    ...
    void shouldUpdateComment() {
        ...
        commentRepository.save(expectedResult);
        Comment actualComment = commentRepository.findById(expectedResult.getId()).orElse(new Comment());
    ...
    void shouldReturnCommentById() {
        ...
        Comment actualComment = commentRepository.findById(expectedComment.getId()).orElse(new Comment());

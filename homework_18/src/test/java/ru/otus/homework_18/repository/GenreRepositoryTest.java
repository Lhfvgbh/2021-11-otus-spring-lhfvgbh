...
class GenreRepositoryTest {
    ...
    void shouldInsertGenre() {
        ...
        Genre actualResult = genreRepository.findById(expectedResult.getId()).orElse(new Genre());
    ...
    void shouldReturnGenreById() {
        ...
        Genre actualGenre = genreRepository.findById(expectedGenre.getId()).orElse(new Genre());

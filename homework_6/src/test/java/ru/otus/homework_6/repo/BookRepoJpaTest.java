...
class BookRepoJpaTest {
    ...
    void shouldReturnBookCount() {
        long actualResult = bookRepoJpa.count();
    ...
    void shouldInsertBook() {
        ...
        Book actualBook = bookRepoJpa.save(expectedBook);
    ...
    void shouldReturnBookById() {
        Book expectedBook = testEntityManager.find(Book.class, EXISTING_BOOK_ID);
        Book actualBook = bookRepoJpa.getById(EXISTING_BOOK_ID).orElse(new Book());
        assertThat(actualBook).usingRecursiveComparison().isEqualTo(expectedBook);
    }
    ...
    void shouldReturnBookByTitle() {
        Book expectedBook = testEntityManager.find(Book.class, EXISTING_BOOK_ID);
        List<Book> actualBookList = bookRepoJpa.getByTitle(EXISTING_BOOK_TITLE);
    ...
    void shouldReturnExpectedBooksList() {
        ...
        List<Book> actualBookList = bookRepoJpa.getAll();
        assertThat(actualBookList).contains(expectedBook);
    ...
    void shouldDeleteBookById() {
        ...
        bookRepoJpa.deleteById(EXISTING_BOOK_ID);
